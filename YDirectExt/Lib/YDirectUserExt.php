...
/**
  *  APIADLib
  * This class extends functionality of {@link YDirectUser} 
...
/** Required classes **/
require_once dirname(__FILE__) . '/../../YDirect/Lib/YDirectUser.php';
require_once dirname(__FILE__) . '/../Util/YDirectException.php';

  
/**
 * Extends user class {@link YDirectUser} for the Yandex.Direct API to create 
